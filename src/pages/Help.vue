      ...
      <div class="help-container pull-right">
        <div class="panel default-panel help-panel">
          ...
          <div class="panel-body">
            ...
            <h6 class="title">Average Influence Score (平均影响力分值)</h6>
            ...
            <p>平均影响力分数为~350，并且所有用户中80％的影响力分数小于400. 高于平均影响力分数（> 350）的分布遵循经典的长尾分布。</p>
            ...
            <p>我们如来何计算影响力分数？它是从KOL的参与度（赞数，分享等）和社交范围（粉丝数量，追踪数量等）汇总而来，因此与这两个指标密切相关。 为了说明，下表显示了具有不同影响力分数的微信用户的一些示例，并提供了平均参与度作为参考：</p>
            ...
            <p>标签云显示KOL内容中经常出现的关键词（品牌，产品，地域和其他基本概念）。</p>

            <h6 class="title">Number of clients (客户数量):</h6>
